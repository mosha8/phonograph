...
const requestDataSchema = z.object({
  q: z.string().min(1, { message: 'Type search phrase.' }),
  type: itemSchema.array(),
  market: z.string().optional(),
  limit: z.number().optional(),
  offset: z.number().optional(),
  include_externals: z.string().optional(),
});
...
const keyGenerator: QueryKeyGenerator<RequestData> = (data) => ['search', data];

export {
  formValuesSchema as audioSearchFormValueSchema,
  keyGenerator as audioSearchKeyGenerator,
  requestDataSchema as audioSearchRequestData,
  responseDataSchema as audioSearchResponseData,
  itemSchema as searchItemSchema,
};
export type {
  FormValueSchema as AudioSearchFormValueSchema,
